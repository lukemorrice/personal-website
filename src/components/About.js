			...
			<section data-section="about" class="section" id="about">
				...
				<div>
					...
					<p class="description">
						...
						from Aberdeen, Scotland but attend{" "}
						<span style={{ fontWeight: "600" }}>Edinburgh University</span>;
						currently about to begin my 4th year. My degree is{" "}
						<span style={{ fontWeight: "600" }}>
							Artificial Intelligence and Computer Science
						</span>
						, which I love. Specifically, I enjoy the Data Science and Software
						Engineering aspects, revolving around Machine Learning.
						<br /> <br />
				...
				<div>
					...
					<p class="description">
						...
						<span style={{ fontWeight: "600" }}>marathon</span> before my 22nd
